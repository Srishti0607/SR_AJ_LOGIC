...
export class BulkDeleteComponent implements OnInit {
  ...
  constructor(private crudSrv: CrudService,private snackBar: MatSnackBar) { }
  ...
  getDetailsToDelete() {
    this.subscriptionsList.push(
      this.crudSrv.getDataToDelete().subscribe((data: any) => {
        if (data) {
  ...
  getDetailsToDeleteCheck() {
    this.subscriptionsList.push(
      this.crudSrv.getDataToDeleteCheck().subscribe((data: any) => {
        if (data) {
