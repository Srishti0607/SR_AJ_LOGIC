...
import { FieldAscSortPipe, CapitalPipe, SearchPipe, ImpureSortPipe, AlphaSortPipe, ConvertPipe, OrderByPipe, NumberToWordsPipe } from "./pipes/custom.pipe";
...
const ASSIGNMENT_CONFIG = Object.freeze({
  startMonth: 'January',
});
...
@NgModule({
  ...
  providers: [
    ...
    [{ provide: 'FIRSTNAME', useValue: 'Kameshwara' }],
    [{ provide: 'CONFIG', useValue: ASSIGNMENT_CONFIG }],
    {
      provide: 'FACT',
    ...
    },
    {
      provide: 'FUNC',
      useValue: () => {
        return 'Use Value Function';
      }
    },
    {
      provide: 'FUNC1',
      useFactory: () => {
        return 'Use Factory Function';
      }
    },
    { provide: ProvideSampleService, useClass: ProvideSampleService },
    { provide: LandingService, useExisting: ProvideSampleService },
